...
pillow_docs = {
    ...
    **compression**
    ...
    To add read or write support to your app, use
    ...
    **disposal**
    ...
    with embedded GRIB data, or files with multiple GRIB fields, your app
    ...
    **jfif**
        JFIF app marker found. If the file is not a JFIF file, this key is
        not present.
    ...
    **adobe**
        Adobe app marker found. If the file is not an Adobe JPEG file, this
        key is not present.
    ...
    **dpi**
    ...
    support, but not enough to be useful for any real app.

    In PIL 1.1.5 and later, the WMF driver is a stub driver. To add WMF read or
    write support to your app, use
