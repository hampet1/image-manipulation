...
def appdata_dir(appname=None, roaming=False):
    ...
    Get the path to the app directory, where applications are allowed
    ...
    # portable distro or a frozen app that wants to be portable)
    prefix = sys.prefix
...
def resource_dirs():
    ...
    (~/.imageio on Linux). The list further contains the app
