...
def is_running_from_reloader() -> bool:
    """Checks if the app is running from within the Werkzeug
    reloader subprocess.
...
def run_simple(
    ...
    """Start a WSGI app. Optional features include a reloader,
    ...
    :param application: the WSGI app to execute
    ...
    :param static_files: a list or dict of paths for static files.  This works
                         ...
                         just wrapping the app in that middleware before
                         serving.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run the given WSGI app with the development server.",
        allow_abbrev=False,
    )
    parser.add_argument(
        "-b",
    ...
    parser.add_argument(
        "app", help="Application to import and serve, in the form module:app."
    )
